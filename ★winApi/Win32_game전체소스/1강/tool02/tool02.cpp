// tool02.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
SIZE g_szBottomWndSize, g_szMenuDlgSize;
HWND g_hWnd, g_hDlgWnd, g_hBottomWnd;
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_TOOL02, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TOOL02));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TOOL02));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_TOOL02);
	...
	wcex.lpszClassName = "BottomWnd"; // 이게 가장 중요함
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		szMainWndSize.cy = ( szWindowSize.cy - 30 ) * 0.70f;
		g_szBottomWndSize.cx = szMainWndSize.cx;
		g_szBottomWndSize.cy = ( szWindowSize.cy - 30 ) - szMainWndSize.cy;
		g_szMenuDlgSize.cx = szWindowSize.cx - szMainWndSize.cx;
		g_szMenuDlgSize.cy = ( szWindowSize.cy - 30 );

		MoveWindow(hWnd, 0, 0, szMainWndSize.cx, szMainWndSize.cy, TRUE); // 메인 윈도우 크기 조정
		g_hBottomWnd = CreateWindow( "BottomWnd", "뷰2", WS_POPUP|WS_CAPTION|WS_THICKFRAME|WS_VISIBLE,
									 0, szMainWndSize.cy, g_szBottomWndSize.cx, g_szBottomWndSize.cy, 
									 hWnd, NULL, hInst, NULL);
		

		g_hDlgWnd = CreateDialog(hInst, MAKEINTRESOURCE(IDD_DIALOG1), hWnd, MenuDlg);
